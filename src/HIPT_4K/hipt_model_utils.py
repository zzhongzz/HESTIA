...
def get_vit256(
    pretrained_weights=None, arch="vit_small", device="cuda:0"
):
    r"""
    ...
    model256:vits.VisionTransformer = vits.__dict__[arch](patch_size=16, num_classes=0)
...
def get_vit4k(
    ...
    checkpoint_key = "teacher"
    model4k:vits4k.VisionTransformer4K = vits4k.__dict__[arch](num_classes=0)
